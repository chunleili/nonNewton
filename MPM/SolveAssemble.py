# function   [A11, A12, A13, A21, A22, A23, A31, A32, A33, B1, B2, B3]= SolveAssemble(X20, Hk, dMu, Mt, A22d, NBS, beta, Re, G1, D, G, xi, nk, vk, dt)
# A11=speye(6*nk)-dt*beta/Re*G1*dMu*D;
# A12=-dt*G1*dMu*D;
# A13=dt*G1*dMu*G;
# A21=-2*xi*dt^2*beta/Re*G1*dMu*D;
# A22=Mt+ A22d - 2*xi*dt^2*G1*dMu*D;
# A23= 2*xi*dt^2*G1*dMu*G;
# A31=-dt*beta/Re*G'*dMu*D;
# A32=dt*G'*dMu*D;
# A33=(dt*G'*dMu*G);
